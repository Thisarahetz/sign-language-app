    ...
    <div data-barba-namespace="home" data-barba="container" className="page-content homepage">
      ...
      <div className="section">
        <div className="padding-global">
          <div className="container-large">
            <div>
              <div className="section_component is-hero-bottom">
        ...
        <div className="padding-global">
          <div className="container-large">
            <div className="padding-top padding-huge">
              <div className="w-layout-grid grid-2-column is-sign">
                ...
                <div id="w-node-_66163284-bd82-de5f-9550-7e7f17b75058-51c2df9a" className="grid-content-right">
                  <div className="image-wrapper is-home-hero-wrapper"><img src="images/Frame-1.png" loading="lazy" sizes="(max-width: 479px) 92vw, (max-width: 767px) 95vw, (max-width: 991px) 92vw, 94vw" srcSet="images/Frame-1-p-500.png 500w, images/Frame-1-p-800.png 800w, images/Frame-1-p-1080.png 1080w, images/Frame-1.png 1236w" alt="" className="image-contain is-home-hero"/></div>
                </div>
              </div>
            </div>
          </div>
      ...
      <div className="section is-home-features">
        <div className="padding-global">
          <div className="container-large">
      ...
      <div className="section is-home-explore">
        <div className="padding-global">
          <div className="container-large">
            <div className="padding-section-medium">
              <div className="section_component">
      ...
      <div className="section is-home-classroom"><img src="images/smiley-teacher-classroom-1.jpg" loading="lazy" sizes="100vw" srcSet="images/smiley-teacher-classroom-1-p-500.jpg 500w, images/smiley-teacher-classroom-1-p-800.jpg 800w, images/smiley-teacher-classroom-1-p-1080.jpg 1080w, images/smiley-teacher-classroom-1-p-1600.jpg 1600w, images/smiley-teacher-classroom-1-p-2000.jpg 2000w, images/smiley-teacher-classroom-1-p-2600.jpg 2600w, images/smiley-teacher-classroom-1-p-3200.jpg 3200w, images/smiley-teacher-classroom-1.jpg 4032w" alt="" className="image-cover is-home-hero"/>
        <div className="home-hero-gradient"></div>
        <div className="padding-global">
          <div className="container-large">
            <div className="padding-section-large">
              <div className="section_component is-home-hero">
                <div className="w-layout-grid grid-2-column is-home-asl">
      ...
      <div className="footer-component">
            ...
            <div className="container-large">
              <div className="padding-vertical padding-huge">
                <div className="footer_top-wrapper">
                  <div className="footer_top-left-wrapper">
                    <div className="margin-top margin-small">
                      <div className="heading-style-h1 text-weight-medium">Let&#x27;s talk! </div>
                    </div>
                    <div className="margin-top margin-small">
        ...
        <div className="section footer_bottom-wrapper">
          <div className="page-padding">
            <div className="container-large">
              <div className="footer_bottom-row">
                ...
                <div id="w-node-_0e235910-451e-a05f-aab0-44f502918f63-02918f22" className="social-wrapper">
                  <a aria-label="Facebook link" href="#" target="_blank" className="social-link w-inline-block">
                    <div className="social-icon w-embed"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24">
                        <path fill="none" d="M0 0h24v24H0z"></path>
                        <path d="M14 13.5h2.5l1-4H14v-2c0-1.03 0-2 2-2h1.5V2.14c-.326-.043-1.557-.14-2.857-.14C11.928 2 10 3.657 10 6.7v2.8H7v4h3V22h4v-8.5z" fill="currentColor"></path>
                      </svg></div>
                  </a>
                  <a aria-label="Twitter link" href="#" className="social-link w-inline-block">
                    <div className="social-icon w-embed"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24">
                        <path fill="none" d="M0 0h24v24H0z"></path>
                        <path d="M15.3 5.55a2.9 2.9 0 0 0-2.9 2.847l-.028 1.575a.6.6 0 0 1-.68.583l-1.561-.212c-2.054-.28-4.022-1.226-5.91-2.799-.598 3.31.57 5.603 3.383 7.372l1.747 1.098a.6.6 0 0 1 .034.993L7.793 18.17c.947.059 1.846.017 2.592-.131 4.718-.942 7.855-4.492 7.855-10.348 0-.478-1.012-2.141-2.94-2.141zm-4.9 2.81a4.9 4.9 0 0 1 8.385-3.355c.711-.005 1.316.175 2.669-.645-.335 1.64-.5 2.352-1.214 3.331 0 7.642-4.697 11.358-9.463 12.309-3.268.652-8.02-.419-9.382-1.841.694-.054 3.514-.357 5.144-1.55C5.16 15.7-.329 12.47 3.278 3.786c1.693 1.977 3.41 3.323 5.15 4.037 1.158.475 1.442.465 1.973.538z" fill="currentColor"></path>
                      </svg></div>
                  </a>
                  <a aria-label="Linkedin link" href="#" target="_blank" className="social-link w-inline-block">
                    <div className="social-icon w-embed"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24">
                        <path fill="none" d="M0 0h24v24H0z"></path>
