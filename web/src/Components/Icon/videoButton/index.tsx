  ...
  return (
    <a href="#" className="video-button-wrapper w-inline-block">
      <div className="icon-1x1-small w-embed">
        ...
        >
          <path
            d="M223.821,76.022c10.333-0.333,19-4.333,26-12s10.333-16.667,10-27c-0.333-10.335-4.167-19.168-11.5-26.5c-7.333-7.333-16.167-10.833-26.5-10.5s-19,4.333-26,12s-10.5,16.667-10.5,27s3.833,19.167,11.5,26.5S213.488,76.355,223.821,76.022z"
            fill="currentColor"
          />
          <path
